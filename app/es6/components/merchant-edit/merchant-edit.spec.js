...
var page = requireHelper.page('merchant_edit')(merchant.id);
...
describe('edit merchant', function() {
  beforeEach(function() {
    specHelper.stubRequests([
      ...
      requireHelper.request('merchant_update')(merchant.id),
  ...
  it('can edit merchant', function() {
    ...
    expect(page.toastMessage.getText()).toEqual('Merchant updated.');
